...
VL_INLINE_OPT void Vcpu___024root___sequent__TOP__1(Vcpu___024root* vlSelf) {
    ...
    // Init
    CData/*4:0*/ __Vdlyvdim0__cpu__DOT__RegALU__DOT__Reg__DOT__rom_array__v0;
    IData/*31:0*/ __Vdlyvval__cpu__DOT__RegALU__DOT__Reg__DOT__rom_array__v0;
    CData/*0:0*/ __Vdlyvset__cpu__DOT__RegALU__DOT__Reg__DOT__rom_array__v0;
    // Body
    __Vdlyvset__cpu__DOT__RegALU__DOT__Reg__DOT__rom_array__v0 = 0U;
    if (vlSelf->cpu__DOT__WEn) {
        __Vdlyvval__cpu__DOT__RegALU__DOT__Reg__DOT__rom_array__v0 
            = vlSelf->cpu__DOT__RegALU__DOT__SUM;
        __Vdlyvset__cpu__DOT__RegALU__DOT__Reg__DOT__rom_array__v0 = 1U;
        __Vdlyvdim0__cpu__DOT__RegALU__DOT__Reg__DOT__rom_array__v0 
            = (0x1fU & (vlSelf->cpu__DOT__instruction 
                        >> 7U));
    }
    vlSelf->cpu__DOT__RegALU__DOT__Read1 = vlSelf->cpu__DOT__RegALU__DOT__Reg__DOT__rom_array
        [(0x1fU & (vlSelf->cpu__DOT__instruction >> 0xfU))];
    vlSelf->cpu__DOT__RegALU__DOT__Read2 = vlSelf->cpu__DOT__RegALU__DOT__Reg__DOT__rom_array
        [(0x1fU & (vlSelf->cpu__DOT__instruction >> 0x14U))];
    vlSelf->a0 = vlSelf->cpu__DOT__RegALU__DOT__Reg__DOT__rom_array
        [(0x1fU & (vlSelf->cpu__DOT__instruction >> 7U))];
    if (__Vdlyvset__cpu__DOT__RegALU__DOT__Reg__DOT__rom_array__v0) {
        vlSelf->cpu__DOT__RegALU__DOT__Reg__DOT__rom_array[__Vdlyvdim0__cpu__DOT__RegALU__DOT__Reg__DOT__rom_array__v0] 
            = __Vdlyvval__cpu__DOT__RegALU__DOT__Reg__DOT__rom_array__v0;
    }
}
...
VL_INLINE_OPT void Vcpu___024root___sequent__TOP__2(Vcpu___024root* vlSelf) {
    ...
    vlSelf->cpu__DOT__RegALU__DOT__MuxOut = ((IData)(vlSelf->cpu__DOT__ALUsrc)
                                              ? ((IData)(vlSelf->cpu__DOT__ALUsrc)
                                                  ? vlSelf->cpu__DOT__Imm
                                                  : vlSelf->cpu__DOT__RegALU__DOT__Read2)
                                              : vlSelf->cpu__DOT__RegALU__DOT__Read2);
    vlSelf->cpu__DOT__RegALU__DOT__SUM = ((4U & (IData)(vlSelf->cpu__DOT__ALUctrl))
                                           ? 0U : (
                                                   (2U 
                                                   ...
                                                   ((1U 
                                                     & (IData)(vlSelf->cpu__DOT__ALUctrl))
                                                     ? 
                                                    (vlSelf->cpu__DOT__RegALU__DOT__Read1 
                                                     | vlSelf->cpu__DOT__RegALU__DOT__MuxOut)
                                                     : 
                                                    (vlSelf->cpu__DOT__RegALU__DOT__Read1 
                                                     & vlSelf->cpu__DOT__RegALU__DOT__MuxOut))
                                                    : 
    ...
    if ((5U == (IData)(vlSelf->cpu__DOT__ALUctrl))) {
        vlSelf->cpu__DOT__RegALU__DOT__SUM = ((vlSelf->cpu__DOT__RegALU__DOT__Read1 
                                               > vlSelf->cpu__DOT__RegALU__DOT__MuxOut)
                                               ? 1U
                                               : 0U);
    }
    vlSelf->cpu__DOT__EQ = (vlSelf->cpu__DOT__RegALU__DOT__Read1 
                            == vlSelf->cpu__DOT__RegALU__DOT__MuxOut);
